                                        ...
                                        @csrf
                                            ...
                                            <div class="eight wide field">
                                                ...
                                                <select name="timezone" class="ui search dropdown uppercase">
                                                    ...
                                                    <!--<option value="West_Africa Standard Time (GMT +1)" @if($data->timezone == "West Africa Standard Time (GMT +1)") selected @endif>West Africa Standard Time (GMT +1)</option>-->
													...
													<option value="WAT/cameroon" @if($data->timezone == "WAT/cameroon") selected @endif>(UTC +01:00) WAT/cameroon</option>
                            ...
                            <div class="tab-content">
                                <p class="license col-md-6" style="margin-bottom:0">
                                    ...
                                    <div class="footer-text">
                                        <div class="sub header">Thank You</div>
                                        <div class="sub header">Proudly Developed by Akum Blaise Acha</div>
                                    </div>
                                </p>
