...
4. Import database from /Application/database/ folder named database.sql to your database server. Create a database user and grant all necessary permissions to the database on your server.
